...
**Week 2** · supervillain (2-0) · FAAB left **$70** · generated 2026-09-19 17:55 UTC

## Since last run

_baseline: snapshot committed 2026-09-19 14:18 UTC (3.6h ago) — older than the hourly rebuild, so some of these changes may have been reported last hour too_

- ⚠️ **Michael Pittman (WR-PIT) Questionable → Out** — hulleywood's player's status changed. Next up: **Roman Wilson (WR-PIT)** — FREE AGENT, claim him.
  ↳ _September 19, 2026 — :_ Pittman (foot) has been ruled out for Sunday's game at New England,  Burt Lauten of the Steelers' official site  reports.
...
| 🛡️ | **Justice Hill (RB-BAL)** | INSURANCE | 2.5 | direct handcuff to MY Derrick Henry | 9,720 | $2 |
| · | **Joe Flacco (QB-CIN)** | SPECULATIVE | 0.0 | every man ahead of him is banged up (1 deep); 14,517 adds in 24h — the market has re-rated him | 14,517 | $1 |
...
| 🔹 | **Juwan Johnson (TE-NO)** | STARTER FA | 18.0 | starting for his NFL team and unrostered | 7,250 | $3 |
| 🔹 | **Brenton Strange (TE-JAX)** | STARTER FA | 17.7 | starting for his NFL team and unrostered | 8,910 | $3 |
...
- Concrete starting points:
  ...
  - _2-for-1_ — give **Bhayshul Tuten (RB-JAX) + Tony Pollard (RB-TEN)** (83.0) → get **George Pickens (WR-DAL)** (68.2)
  - _1-for-1_ — give **Bhayshul Tuten (RB-JAX)** (48.0) → get **George Pickens (WR-DAL)** (68.2)
  - _1-for-1_ — give **Rico Dowdle (RB-PIT)** (33.8) → get **Jayden Reed (WR-GB)** (19.2)

### Brooklyn Meatpackers — fit score 60.65
- Roster counts: QB:2 / RB:5 / WR:6 / TE:2
- They need: **RB (31.27), TE (9.07)**
- Shape: I send **RB**, I get back **WR**
- Concrete starting points:
  - _2-for-1_ — give **Tony Pollard (RB-TEN) + Rico Dowdle (RB-PIT)** (68.8) → get **Malik Nabers (WR-NYG)** (63.8)
  - _2-for-1_ — give **Bhayshul Tuten (RB-JAX) + Rico Dowdle (RB-PIT)** (81.9) → get **Malik Nabers (WR-NYG)** (63.8)
  - _2-for-1_ — give **Tony Pollard (RB-TEN) + Rico Dowdle (RB-PIT)** (68.8) → get **Jaylen Waddle (WR-DEN)** (49.7)
...
### mtngoblin — fit score 39.52
- Roster counts: QB:3 / RB:6 / WR:4 / TE:2
- They need: **WR (18.12), RB (10.14), TE (9.92)**
- Shape: I send **RB**, I get back **WR**
- Concrete starting points:
